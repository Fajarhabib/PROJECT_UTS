 ...
 */
public class PelangganDetail extends javax.swing.JDialog {
    //membuat Variable
    private pelanggan mahasiswa;
    private boolean isNew;
    //pembuatan Variable Parents
    private AplikasiDataPelanggan mainFrame;
    /**
     * Creates new form MahasiswaDetail
     */
    public PelangganDetail(JFrame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        //pembuatan Costructor Tambahan
        mainFrame = (AplikasiDataPelanggan) parent; //mengcasting dari aplikasidatamahasiswa
        //karena untuk insert
        isNew = true;
    ...
    public PelangganDetail(JFrame parent, boolean modal, String nim) {
        super(parent, modal);
        initComponents();
        //pembuatan Costructor Tambahan
        mainFrame = (AplikasiDataPelanggan) parent; //mengcasting dari aplikasidatamahasiswa
